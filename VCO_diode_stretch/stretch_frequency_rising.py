...
if __name__ == "__main__":
    ...
    fig.savefig(f"./VCO_diode_stretch/figures/{meas}/{angle}/stretch1_up_{angle}.png", dpi=500)
    fig2 = RelativeStretchGraph1(df)
    fig2.savefig(f"./VCO_diode_stretch/figures/{meas}/{angle}/stretch1_up_{angle}_rel.png", dpi=500)
    fig3 = MakeStretchGraph2(df)
    fig3.savefig(f"./VCO_diode_stretch/figures/{meas}/{angle}/stretch2_up_{angle}.png", dpi=500)
    fig4 = RelativeStretchGraph2(df)
    fig4.savefig(f"./VCO_diode_stretch/figures/{meas}/{angle}/stretch2_up_{angle}_rel.png", dpi=500)
    # plt.show()
