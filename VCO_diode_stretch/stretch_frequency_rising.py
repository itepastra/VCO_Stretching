...
if __name__ == "__main__":
    ...
    df = importCSV(f"./data/{meas}/rising/angle_{angle}.0.csv")
    ...
    fig.savefig(f"./figures/{meas}/{angle}/stretch1_up_{angle}.png", dpi=500)
    fig2 = RelativeStretchGraph1(df)
    fig2.savefig(f"./figures/{meas}/{angle}/stretch1_up_{angle}_rel.png", dpi=500)
    fig3 = MakeStretchGraph2(df)
    fig3.savefig(f"./figures/{meas}/{angle}/stretch2_up_{angle}.png", dpi=500)
    fig4 = RelativeStretchGraph2(df)
    fig4.savefig(f"./figures/{meas}/{angle}/stretch2_up_{angle}_rel.png", dpi=500)
    # plt.show()
