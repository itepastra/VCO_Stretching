...
def ModifyToCSV(filename):
    ...
    df.columns = ["date", "time", "Vctrl", "stretchAmt", "stretchAngle",  "Freq1", "errFreq1",  "Amp1", "errAmp1",  "Freq2", "errFreq2",
                  "Amp2", "errAmp2", "VDD_VCO1_shunt", "VDD_driver_shunt", "VDD", "VDD_VCO2_shunt", "VDD_ring_shunt", "strain_1", "strain_2", "strain_3", "temp"]
    ...
    # the occiloscope only uses the last 32 values, this was upped for measurement 3
    df["AmtFreq1"] = 32
    df["AmtAmp1"] = 32
    df["AmtFreq2"] = 32
    df["AmtAmp2"] = 32
...
if (__name__ == "__main__"):
    meas = "meas_2"
    filename = "Measurement_stretch_2"
